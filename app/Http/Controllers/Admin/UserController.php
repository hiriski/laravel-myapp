...
class UserController extends Controller {
    ...
    public function create() {
        ...
        return view('back.users.create', compact('role'));
    }
    ...
    public function update(Request $request, $id) {
        ...
        return redirect(route('admin.user.index'))->with(['success' => 'User: ' . $user->name . ' has been update']);
    }
    ...
    public function destroy($id) {
        ...
        return redirect()->back()
            ->with(['success' => 'User: ' . $user->name . ' has been delete']);
    }
    ...
    public function rolePermission(Request $request) {
        ...
        return view('back.users.role-permission', compact('roles', 'permissions', 'hasPermission'));
    }
    ...
    public function roles(Request $request, $id) {
        $user = User::findOrFail($id);
        $roles = Role::all()->pluck('name');
        return view('back.users.roles', compact('user', 'roles'));
    }
