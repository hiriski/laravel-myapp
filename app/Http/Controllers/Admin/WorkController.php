...
class WorkController extends Controller {
  public function __construct() {
    ...
    $this->destinationPath  = storage_path() . '/app/public/uploads/images/works';
    $this->dimentions       = [
      'image_xs'          => 82,
      'image_md'          => 640,
    ];
  ...
  public function store(StoreWork $request) {
    ...
    /** jika slug kosong isi name yang sudah di format menjadi slug */
    if(empty($data['slug'])) {
    ...
    if($file = $request->file('image')) {
      ...
      if(!file_exists($this->destinationPath)) {
        /** Perlu di perhatikan
         * method makeDirectory dimulai di folder 'storage/app'
         * Jadi saya hanya perlu membuat directory yang di dalamnya saja sesuai dengan yang saya butuhkan, dalam hal ini adalah directory 'public/uploads/images/blog'
         */
        $createNewDirectories = 'public/uploads/images/works';
      ...
      foreach($this->dimentions as $row => $dimention) {
        ...
        /** Image. example hello_XHrSc_240.jpg or hello_XHrSc_780.jpg  */
  ...
  public function destroy($id) {
    ...
    return redirect()->back()
      ->with('work_delete_success', 'Work has been delete!');
  }
