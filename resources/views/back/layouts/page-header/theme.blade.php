                        ...
                        <div id="navbarPageHeader" class="collapse navbar-collapse">
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item {{ Route::getCurrentRoute()->uri === "admin/blog" ? 'active' : '' }}">
                                    <a href="{{ route('admin.theme.index') }}" class="nav-link">Theme All</a>
                                </li>
                                <li class="nav-item {{ Route::getCurrentRoute()->uri === "admin/blog/create" ? 'active' : '' }}">
                                    <a href="{{ route('admin.theme.create') }}" class="nav-link">Create new</a>
                                </li>
                            ...
                            <form action="" class="form-inline my-2 my-lg-0">
                                <input type="search" placeholder="Search themes.." class="form-control mr-sm-2">
