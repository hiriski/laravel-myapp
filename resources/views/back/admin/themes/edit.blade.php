        ...
        <div class="col-sm-12 col-md-11">
            <div class="card">
                <div class="card-body block-padding-lg">
                    {{ Form::model($theme, ['url' => route('admin.theme.update', $theme->id)]) }}
                        @method('PUT')
                        <div class="form-group">
                            <label for="title">Title</label>
                            <input id="title" type="text" class="form-control rux-input  @error('title') is-invalid @enderror" name="title" placeholder="Title" value="{{ $theme->title }}" autofocus>
                            @error('title')
                        ...
                        <div class="form-group form-image-upload">
                            ...
                            <label class="d-flex justify-content-center align-items-center" for="blogImage" id="dragImageHere">
                                ...
                                <div class="imageResult">
                                    <img src="{{ getThemeImage($theme->image_md) }}" alt="preview" id="imagePreview" class="">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="slug" type="text" class="form-control rux-input @error('slug') is-invalid @enderror" name="slug" placeholder="Slug" value="{{ $theme->slug }}">
                            @error('slug')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
