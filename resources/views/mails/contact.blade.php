...
<head>
  ...
  <style type="text/css" media="screen">
    ...
    .gradient { background: linear-gradient(to right, #2196F3 0%,#38ff35 100%) }
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 0; padding: 0; width: 100%; height: 100%;" bgcolor="#f4ecfa" class="gwfw">
      <tr>
        <td style="margin: 0; padding: 0; width: 100%; height: 100%;" align="center" valign="top">
          <table width="600" border="0" cellspacing="0" cellpadding="0" class="m-shell" style="padding-bottom:20px;">
            <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="mpx-10">
                                              ...
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  <td class="fluid-img img-center pb-50" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 20px;">
                                                    {{-- <img src="https://www.psd2newsletters.com/templates/purple/images/img_intro_7.png" width="282" height="300" border="0" alt="" /> --}}
                                                  </td>
                                                </tr>
                                                <tr>
                                                  <td class="title-30 a-center pb-10" style="font-size:30px; line-height:34px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-top: 30px;padding-bottom: 10px;">
                                                    Hi, Riski 👋
                                                  </td>
                                                </tr>
                                                <tr>
                                                  <td class="title-36 a-center pb-35" style="font-size:20px; line-height:28px; color:#454b5b; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
                                                    <strong>New Message From "{{ $contact->name }}"</strong>
                                                  </td>
																								</tr>
																								
																								{{-- Topic --}}
																								<tr>
																									<td style="font-size:18px; line-height:24px; color:#454b5b; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 30px;">
																									Topic : <strong>{{ $contact->topic->name }}</strong>
																									</td>
																								</tr>
                                                ...
                                                <tr>
                                                  <td class="py-30">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      <tr>
                                                        <td class="py-35 px-50 mpx-15" style="border-radius: 10px; padding-top: 30px; padding-bottom: 30px; padding-left: 40px; padding-right: 40px;" bgcolor="#f4ecfa">
                                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                              <td>
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: -90px;">
                                                                  <tr>
                                                                    <td class="img-center pb-20" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 20px;">
                                                                      {{-- <img src="https://www.psd2newsletters.com/templates/purple/images/img_avatar.png" width="110" height="110" border="0" alt="" /> --}}
                                                                    </td>
                                                                  </tr>
                                                                </table>
                                                              </td>
                                                            ...
                                                            <tr>
                                                              <td class="text-18 a-center c-purple pb-15" style="font-size:18px; line-height:22px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; color:#1f77ff; padding-bottom: 15px;">
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td class="p-50 mpx-15" bgcolor="#949196" style="border-radius: 0 0 10px 10px; padding: 5px;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                ...
                                <tr>
                                  <td class="text-14 lh-24 a-center c-white l-white pb-20" style="font-size:14px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 24px; text-align:center; color:#ffffff; padding-bottom: 20px;">
                                    Pesan ini dikirim secara otomatis dari website
																		<br />
																		<a href="riski.web.id" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">riski.web.id</span></a>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="center">
