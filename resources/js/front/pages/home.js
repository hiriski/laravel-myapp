...
import { breakpoint, isMobileLg } from '../media-queries';
...
/** Layout Style */
const moveHero = (position) => {
	hero.dataset.position = position;
...
if((isIndex() && isMobileLg())) {
	...
	/** Hero Nav Toggler for Mobile */
	let heroNavToggler = document.getElementById('hero_nav_toggler');
	if(heroNavToggler) {
		heroNavToggler.addEventListener('click', function() {
			showHeroMenuOnMobile('show');
		});
	}
