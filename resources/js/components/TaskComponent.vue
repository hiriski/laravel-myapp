...
<script>
    export default {
        ...
        methods: {
            ...
            createTask() {
                axios.post('http://app.local/task', {
                    name: this.task.name,
            ...
            updateTask() {
                axios.patch('http://app.local/task/' + this.update_task.id, {
            ...
            deleteTask(index) {
                ...
                if (conf === true) {
                    axios.delete('http://app.local/task/' + this.tasks[index].id)
                        .then(response => {
