/* PrismJS 1.20.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+git+graphql+http+json+kotlin+less+markup-templating+php+php-extras+pug+python+jsx+tsx+regex+sass+scss+sql+typescript */
